...
namespace Hero_Designer
{
    public partial class frmEditPowerset : Form
    {
        ...
        void btnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Powerset name '" + ps.FullName + " is invalid.", @"No Can Do");
            }
            else if (!PowersetFullNameIsUnique(Convert.ToString(ps.nID)))
            {
                MessageBox.Show("Powerset name '" + ps.FullName + " already exists, please enter a unique name.", @"No Can Do");
            }
            else
            {
        ...
        void btnIcon_Click(object sender, EventArgs e)
        {
            ...
            {
                int num = (int)MessageBox.Show("You must select an image from the " + I9Gfx.GetPowersetsPath() + " folder!\r\n\r\nIf you are adding a new image, you should copy it to the folder and then select it.", @"Ah...");
            }
            else
            {
                myPS.ImageName = str;
