...
namespace Hero_Designer
{
    public partial class frmEnhEdit : Form
    {
        ...
        {
            if (lvEnh.SelectedIndices.Count <= 0 || MessageBox.Show("Really delete enhancement: " + lvEnh.SelectedItems[0].Text + "?", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
                return;
