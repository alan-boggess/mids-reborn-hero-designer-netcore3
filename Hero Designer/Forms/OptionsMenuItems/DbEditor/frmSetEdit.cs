...
namespace Hero_Designer
{
    public partial class frmSetEdit : Form
    {
        ...
        void lvBonusList_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (index < 0)
            {
                int num = (int)MessageBox.Show("Tag was < 0!", null, MessageBoxButtons.OK);
            }
            else
            {
                if (isBonus())
