...
namespace Hero_Designer
{
    public partial class frmRecipeEdit : Form
    {
        ...
        {
            if (MessageBox.Show(@"Do you really want to erase all stored recipes and attempt a import?", @"Careful..", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) != DialogResult.Yes)
                return;
            char[] delimiter = { '\r' };
            ...
            FillList();
            MessageBox.Show(@"Done. Recipe-Enhancement links have been guessed.", @"Import", MessageBoxButtons.OK, MessageBoxIcon.Information);
        });
