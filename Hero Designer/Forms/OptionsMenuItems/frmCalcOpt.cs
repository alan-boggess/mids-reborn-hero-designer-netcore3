...
namespace Hero_Designer
{
    public partial class frmCalcOpt : Form
    {
        ...
        {
            if (csList.Items.Count <= 0 || MessageBox.Show($@"Are you sure you wish to Delete {csList.SelectedItem} ?", @"Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
                return;
        ...
        {
            if (MessageBox.Show(@"This will remove all of the color schemes and replace them with the defaults. Are you sure?", @"Reset", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
                return;
        ...
        {
            if (fcList.Items.Count <= 0 || MessageBox.Show($@"Are you sure you wish to Delete {fcList.SelectedItem} ?", @"Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
                return;
        ...
        {
            if (MessageBox.Show(@"This will remove all of the formatting code sets and replace them with the default set. Are you sure?",@"Reset", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) != DialogResult.Yes)
                return;
