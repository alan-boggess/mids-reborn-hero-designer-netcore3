    ...
    public partial class frmImport_Archetype : Form
    {
...

        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message,"Archetype Class CSV Not Opened", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            catch (Exception ex)
            {
                ...
                iStream.Close();
                MessageBox.Show(exception.Message, "Archetype Class CSV Parse Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ProjectData.ClearProjectError();
                return false;
            }
            iStream.Close();
            MessageBox.Show("Parse Completed!\r\nTotal Records: " + Convert.ToString(num3) + "\r\nGood: " + Convert.ToString(num1) + "\r\nBad: " + Convert.ToString(num4), "File Parsed");
            return true;
        }
...

        {
            ...
            MessageBox.Show("Import of " + Convert.ToString(num1) + " classes completed!", "Done");
            DisplayInfo();
            return false;
        }
    }
