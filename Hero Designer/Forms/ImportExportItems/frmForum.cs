...
namespace Hero_Designer
{
    public partial class frmForum : Form
    {
        ...
        void ibExport_ButtonClicked()
        {
            ...
            MessageBox.Show("The build data has been placed on the clipboard and is ready to paste into a forum post. If your forum allows you to disable emoticons/smileys in your post, you should do so.", "Export Done");
            Hide();
        }
