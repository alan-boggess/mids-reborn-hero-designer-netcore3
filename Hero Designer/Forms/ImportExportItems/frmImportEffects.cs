...
namespace Hero_Designer
{
    public partial class frmImportEffects : Form
    {
...

        {
            ...
            BusyHide();
            MessageBox.Show("Import of " + Convert.ToString(num1) + " records completed!\r\nOf these, " + Convert.ToString(num3) + " records were found read-only.", "Done");
            DisplayInfo();
            return false;
        }
    }
