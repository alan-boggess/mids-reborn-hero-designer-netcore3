...
namespace Hero_Designer
{
    public partial class frmImport_Recipe : Form
    {
        ...
        bool ImportRecipeCSV(string iFName1, string iFName2)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Recipe CSVs Not Opened", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            int num1 = 0;
            int num2 = 0;
            ...
            try
            {
                ...
                MessageBox.Show("Done. Recipe-Enhancement links have been guessed.", "Import");
            }
            catch (Exception ex)
            {
                ...
                iStream2.Close();
                BusyHide();
                MessageBox.Show(exception.Message, "CSV Parse Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            BusyHide();
            iStream2.Close();
            MessageBox.Show("Parse Completed!\r\nTotal Records: " + num5 + "\r\nGood: " + num2 + "\r\nRejected: " + num3, "File Parsed");
