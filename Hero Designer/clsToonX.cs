    ...
    public class clsToonX : Character
    {
        ...
        bool ImportInternalDataUC(StreamReader iStream, float nVer)
        {
            ...
            if (nVer < 1.0)
            {
                ...
                if (olderFile >= 0.899999976158142 && olderFile < 1.0)
                    olderFile = 0.0f;
                MessageBox.Show(@"The data being loaded was saved by an older version of the application, and may not load correctly. Should be OK though.", @"FYI", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
                olderFile = 0.0f;
        ...
        bool ReadInternalDataUC(StreamReader iStream)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show(@"The data being loaded was saved by an older version of the application, attempting conversion.", @"FYI", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
